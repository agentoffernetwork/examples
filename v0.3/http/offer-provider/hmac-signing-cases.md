...
> Current v0.3 reference vectors for Partner implementations of AON → Partner request
...
>
> See the [OfferProvider API](https://github.com/agentoffernetwork/protocol/blob/main/v0.3/specs/offer-provider-api.md)
...
| Protocol header | `AON-Protocol-Version: 0.3` |
