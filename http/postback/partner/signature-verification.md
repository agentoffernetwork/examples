...
| Canonical body (exact bytes) | `{"event_id":"evt_pb_NWS66E195DM66YEK30HJKSVVYN","event_type":"conversion","aon_tracking_id":"trk_01_click_abc","aon_click_id":"aci_019e30f2-1b35-7b58-b47d-2cc086ace710","offer_id":"ao_01HX2B3C4D5E6F7G8H9J0KABCD","conversion_id":"partner_conv_98765","timestamp":"2026-03-21T03:10:00Z","conversion_type":"sale","amount":120,"bid":24,"currency":"USD","sub_id_1":"homepage_widget","coupon_code":"SPRING2026"}` |
...
| `X-AON-Signature` | `3fe77e9a6f8f783e20e5ead5f1938edfed128a82486a345fe9b5a560829d1b8b` |
...
| `X-AON-Signature` | `4d24beaf6c336977b7104bfc82dbda9131d396901fd757d8fae222b555dd5573` |
...
| `X-AON-Nonce` | `c3d4e5f6-a7b8-9012-cdef-123456789012` |
| `X-AON-Signature` | `878c7d050f945d5e4c4078720795913ee480be1cafa6d91c1face0b64e0b555f` |
...
const body = `{"event_id":"evt_pb_NWS66E195DM66YEK30HJKSVVYN","event_type":"conversion","aon_tracking_id":"trk_01_click_abc","aon_click_id":"aci_019e30f2-1b35-7b58-b47d-2cc086ace710","offer_id":"ao_01HX2B3C4D5E6F7G8H9J0KABCD","conversion_id":"partner_conv_98765","timestamp":"2026-03-21T03:10:00Z","conversion_type":"sale","amount":120,"bid":24,"currency":"USD","sub_id_1":"homepage_widget","coupon_code":"SPRING2026"}`;
...
```bash
printf 'POST\n/v1/postback\n%s\n%s\n%s' \
  '{"event_id":"evt_pb_NWS66E195DM66YEK30HJKSVVYN","event_type":"conversion","aon_tracking_id":"trk_01_click_abc","aon_click_id":"aci_019e30f2-1b35-7b58-b47d-2cc086ace710","offer_id":"ao_01HX2B3C4D5E6F7G8H9J0KABCD","conversion_id":"partner_conv_98765","timestamp":"2026-03-21T03:10:00Z","conversion_type":"sale","amount":120,"bid":24,"currency":"USD","sub_id_1":"homepage_widget","coupon_code":"SPRING2026"}' \
  1776450600 \
  c3d4e5f6-a7b8-9012-cdef-123456789012 \
  | openssl dgst -sha256 -hmac "partner-postback-secret-demo" -hex
```

Both commands yield `3fe77e9a...1d1b8b` for Case 1.
